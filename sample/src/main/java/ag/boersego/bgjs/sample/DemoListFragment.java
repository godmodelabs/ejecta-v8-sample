 ...
 * currently being viewed in a {@link DemoEjectaFragment}.
 * <p>
...
public class DemoListFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int listItemId = android.R.layout.simple_list_item_activated_1;
        if (Build.VERSION.SDK_INT < 11) {
            listItemId = android.R.layout.simple_list_item_1;
        }
